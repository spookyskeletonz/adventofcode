...
public class Day06Test {
  ...
  public void testPartOneBasic() throws FileNotFoundException {
    File file = new File(getClass().getClassLoader().getResource("twentynineteen/day06/basic.txt").getFile());
    assertEquals(42, day.solvePartOne(file));
  }

  @Test
  public void testPartOneInput() throws FileNotFoundException {
    File file = new File(getClass().getClassLoader().getResource("twentynineteen/day06/input.txt").getFile());
    assertEquals(227612, day.solvePartOne(file));
  }

  @Test
  public void testPartTwoBasic() throws FileNotFoundException {
    File file = new File(getClass().getClassLoader().getResource("twentynineteen/day06/basicPartTwo.txt").getFile());
