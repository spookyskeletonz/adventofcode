...
public class Day01Test {
  private final Day01 day = new Day01();
    ...
    public void testPartTwoBasic() throws Exception {
      File file = new File(getClass().getClassLoader().getResource("Day01/testPartTwoBasic.txt").getFile());
      assertEquals(966, day.solveFileForPartTwo(file));
    }

    @Test
    public void testPartTwoAddition() throws Exception {
      File file = new File(getClass().getClassLoader().getResource("Day01/testPartTwoAddition.txt").getFile());
